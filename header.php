...
(() => {
  ...
  <body <?php body_class('bg-gray-50 text-gray-900 dark:bg-gray-900 dark:text-gray-50 transition-colors duration-500'); ?>>
    <?php wp_body_open(); ?>
    <div class="site-wrapper">
      ...
      <nav id="skip-links" class="sr-only focus:not-sr-only" aria-label="Skip links" data-smooth-scroll>
        ...
        <!-- ** Site Header ** -->
<header id="header" class="min-h-[var(--header-h)] sticky z-10 bg-gray-800 text-white shadow-md backdrop-blur">
  <!-- Mobile ( < lg ) -->
  <div id="header-mobile" class="lg:hidden flex items-center justify-between px-4 py-2">
    ...
    <div class="flex items-center gap-x-2">
      ...
      <button id="theme-toggle-mobile" type="button"
        class="p-2 w-8 h-8 flex items-center justify-center rounded-md bg-gray-700"
      ...
      <button data-toggle="mobile-menu" type="button"
        class="p-2 w-9 h-9 inline-flex items-center justify-center rounded-md bg-gray-700 text-white"
  ...
  <!-- Mobile panel -->
  <nav id="mobile-menu" class="w-full bg-gray-900 dark:bg-gray-800 text-gray-100 dark:text-gray-50 py-4 px-2"
    ...
    ?>
        ...
        $show_hero_like = ($image_url_header && (!is_single() || is_singular('machaki')));

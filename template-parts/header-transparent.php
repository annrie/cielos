...
?>
<style>
.header-transparent{position:absolute;top:0;left:0;right:0;background:transparent!important;box-shadow:none!important}
.header-transparent.is-scrolled{position:fixed;background:var(--header-bg)!important;box-shadow:0 1px 3px rgba(0,0,0,.1)!important;backdrop-filter:blur(12px)}
